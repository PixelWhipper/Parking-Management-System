...
template <> constexpr inline auto AdminInputUI::qt_create_metaobjectdata<qt_meta_tag_ZN12AdminInputUIE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_addCustomRateButton_clicked",
        "on_editCustomRateButton_clicked",
        "on_deleteCustomRateButton_clicked"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_addCustomRateButton_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_editCustomRateButton_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_deleteCustomRateButton_clicked'
...
void AdminInputUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_addCustomRateButton_clicked(); break;
        case 3: _t->on_editCustomRateButton_clicked(); break;
        case 4: _t->on_deleteCustomRateButton_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdminInputUI::*)()>(_a, &AdminInputUI::finished, 0))
            return;
    }
}
